<?php
	...
	$active_clientes="";
	$active_usuarios="";	
	$title="Editar Factura | SISREF v2";
	...
	if (isset($_GET['numero_cotizacion']))
	{
		...
		$campos="dc.id_detalle_cotizacion, cl.nombre_cliente, cl.telefono, cl.correo_electronico, dc.numero_cotizacion, p.codigo, p.descripcion, dc.cantidad, dc.precio_venta, co.condiciones, co.fecha_cotizacion";
		$sql_factura=mysqli_query($cnx,"SELECT $campos FROM detalle_cotizacion dc, productos p, cotizaciones co, clientes cl WHERE dc.numero_cotizacion = ".$id_factura." AND p.idProducto = dc.id_producto AND co.atencion = cl.nombre_cliente");
		$count=mysqli_num_rows($sql_factura);
		if ($count==1)
		{
				$rw_factura=mysqli_fetch_array($sql_factura);
				$id_cliente=$rw_factura['idCliente'];
				$nombre_cliente=$rw_factura['nombre_cliente'];
				$telefono_cliente=$rw_factura['telefono'];
				$email_cliente=$rw_factura['correo_electronico'];
				$id_vendedor_db=$rw_factura['idUsuario'];
				$fecha_factura=date("d/m/Y", strtotime($rw_factura['fecha_cotizacion']));
				$condiciones=$rw_factura['condiciones'];
				$estado_factura=$rw_factura['estado'];
				$numero_factura=$rw_factura['numero_cotizacion'];
				$_SESSION['id_cotizacion']=$id_factura;
				$_SESSION['numero_cotizacion']=$numero_factura;
		}	
		else
		{
						...
						<div class="form-group row">
							...
							<div class="col-md-3">
								<select class="form-control input-sm" id="id_vendedor" name="id_vendedor">
									<?php
										$sql_vendedor=mysqli_query($con,"SELECT * FROM usuarios ORDER BY nombre");
