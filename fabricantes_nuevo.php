                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    <h5 class=""><a href="./fabricantes.php" style="text-decoration: none; color: black;"><i class="fa fa-tag"></i> Fabricantes</a> / Nuevo Fabricante</h5>
                        ...
                        <div class="">
                            <div class="card">
                                    <div class="card-header">
                                        Nuevo <strong>Fabricante</strong>
                                    </div>
                                        ...
                                        <form action="" method="post" class="form-horizontal" id="">
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="descripcion" name="descripcion" placeholder="ingresa nombre" class="form-control" required>
                                                    <span class="help-block">Por favor ingresa el nombre del fabricante</span>
                                                </div>
                                            </div>
                                    </div>
