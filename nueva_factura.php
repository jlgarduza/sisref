...
<body class="">
                                ...
                                <form class="form-horizontal" role="form" id="datos_cotizacion">
                                    <div class="ui-widget">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-3">
                                                <input type="text" class="form-control auto" name="atencion" id="atencion" placeholder="Selecciona un cliente" required>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-4">
                                                    <select name="vendedor" id="vendedor" class="form-control" required>
                                                        <?php 
                                                            $vendedor = $cnx->query("SELECT * FROM usuarios"); 
    ...
    <script>
		...
		$("#datos_cotizacion").submit(function(){
		 ...
		 VentanaCentrada('./pdf/documentos/cotizacion_pdf.php?atencion='+atencion+'&tel1='+tel1+'&vendedor='+vendedor+'&email='+email+'&condiciones='+condiciones+'&validez='+validez+'&entrega='+entrega+'&estado='+estado,'Cotizacion','','1024','768','true');
		});
