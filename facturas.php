                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    <h2 class="title-1">Historial de Cotizaciones</h2>
                                ...
                                <tbody>  
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align:center">
                                            ...
                                            <?php }else{} ?>
                                            <a href="editar_factura.php?numero_cotizacion=<?php echo $row->numero_cotizacion ?>" class="btn btn-info btn-sm" title="Ver Detalles"><i class="fa fa-edit"></i></a>
