                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    <h2 class="title-1"><i class="fa fa-cubes"></i> Conteo de Inventario</h2>
                                    ...
                                    <?php
                                        ...
                                        if($grupo == 1){
                                    ?>
                                    <a href="exportar_conteo.php" class="btn btn-primary btn-sm" target="_blank"><i class="fa fa-print"></i> Imprimir Conteo</a>
                                    <!-- <button class="btn btn-primary btn-sm" onclick="location.href='exportar_conteo.php';"><i class="fa fa-upload"></i> Exportar Inventario</button> -->
                                    <?php }else{} ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input id="FiltrarContenido" type="text" class="form-control" placeholder="Ingrese Nombre del Producto" aria-label="Nombre del Producto" aria-describedby="basic-addon1">
                        </div>
                            ...
                            <table style="font-size:12px" class="table table-bordered table-striped">  
                                ...
                                <tbody class="BusquedaRapida">  
                                    ...
                                    while ($row = mysqli_fetch_assoc($rs_result)) {
                                        ...
                                        $prod_code=$row['codigo'];
                                        $prod_name=$row['descripcion'];
                                        $prod_ctry=$row['existencia'];
                                    ?>  
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#" data-target="#editProductModal" class="edit" data-toggle="modal" data-code='<?php echo $prod_code; ?>' data-name="<?php echo $prod_name; ?>" data-category="<?php echo $prod_ctry; ?>" data-id="<?php echo $product_id; ?>"><i class="fas fa-edit" data-toggle="tooltip" title="Editar" ></i></a>
                                            <!-- <a href="#deleteProductModal" class="delete" data-toggle="modal" data-id="<?php echo $product_id;?>"><i class="fas fa-trash" data-toggle="tooltip" title="Eliminar"></i></a> -->
                                        </td>
                                    </tr>  
                                    <?php  
                                    };  
