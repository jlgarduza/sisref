<?php
    ...
    if(isset($_POST) && !empty($_POST)){
        $NombreDepartamento = $dep->sanitize($_POST['NombreDepartamento']);
        
        $res = $dep->crearDep($NombreDepartamento);
        if($res){
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    <h2 class="title-1">Departamentos</h2>
                                    <!-- <button class="btn btn-primary btn-sm" onclick="location.href='departamento_nuevo.php';"><i class="zmdi zmdi-plus"></i> Nuevo</button> -->
                                </div>
                        ...
                        <div class="row col-lg-12">
                            <div class="col-lg-6">
                                <div class="table-responsive">
                                    ...
                                    $sql = "SELECT * FROM departamentos ORDER BY NombreDepartamento ASC LIMIT $start_from, $limit";  
                                        ...
                                        <tbody class="BusquedaRapida">  
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align:right;">
                                                    <a href="usuarios_edicion.php?idDepartamento=<?php echo $row['idDepartamento']?>" class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></a>
                                                    <a href="delete.php?idDepartamento=<?php echo $row['idDepartamento'] ?>" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></a>
                                                </td>
                                            </tr>  
                                            <?php  
                                            };  
                                    ...
                                    <?php  
                                        ...
                                        for ($i=1; $i<=$total_pages; $i++) {  
                                                    $pagLink .= "<a class='page-link' href='departamentos.php?page=".$i."'>".$i."</a>";  
                                        };  
                                        echo $pagLink . "</div>";  
                                    ?>
                                    <!-- END DATA TABLE-->
                                ...
                                <div class="table-responsive">
                                    <div class="card">
                                        <div class="card-header">
                                            Nuevo <strong>Departamento</strong>
                                        </div>
                                        <form action="" method="post" class="form-horizontal" id="">
                                            ...
                                            <div class="<?php echo $class?>">
                                                <?php if(isset($message)){ ?>
                                                    <?php echo $message; header("Location: departamentos.php")?>
                                                <?php } ?>
                                            </div>

                                            <div class="card-footer text-center">
                                                <button type="submit" class="btn btn-success btn-sm">
                                                    <i class="fa fa-save"></i> Guardar Departamento
                                                </button>
                                                <a href="departamentos.php" class="btn btn-danger btn-sm add-new">
                                                    <i class="fa fa-arrow-left"></i> Volver a departamentos
                                                </a>
                                            </div>
                                        </form>
                                    </div>
