<?php
	...
	$active_clientes="";
	$active_usuarios="";	
	$title="Editar Factura | JL Sistemas";
	...
	{
		$id_factura=intval($_GET['numero_cotizacion']);
		...
		$sql_factura=mysqli_query($con,"select $campos FROM facturas, clientes WHERE facturas.id_cliente=clientes.id_cliente and numero_cotizacion='".$id_factura."'");
