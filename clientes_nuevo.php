                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    <h5 class=""><a href="./clientes.php" style="text-decoration: none; color: black;"><i class="fa fa-users"></i> Clientes</a> / Nuevo Cliente</h5>
                        ...
                        <?php
                            ...
                            if(isset($_POST) && !empty($_POST)){
                                ...
                                $res = $clientes->create($codCliente,$nombre,$direccion,$numInt,$numExt,$pais,$estado,$municipio,$colonia,$codigopostal,$telefono,$correo_electronico,$rfc,$razonsocial,$usocfdi);
                                if($res){
                                    ...
                                    <div class="card-body card-block">
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-3">
                                                    <input type="text" name="codcliente" id="codcliente" class='form-control' value="<?php echo generarCodigo(4); ?>" readonly>
                                                    <!-- <input type="text" name="codcliente" id="codcliente" class='form-control' /> -->
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-5">
                                                    <input type="text" name="rfc" id="rfc" class='form-control' maxlength="15" required >
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-5">
                                                    <select name="usoCFDI" id="usoCFDI" class="form-control" required>
                                                        ...
                                                        ?>
                                                        <option value="<?php echo $vuso['codigo']; ?>"><?php echo $vuso['codigo'].' '.utf8_encode($vuso['descripcion']); ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-2">
                                                    <input type="text" name="numExt" id="numExt" class='form-control' required >
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
