                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-5">
                                <div class="overview-wrap">
                                    <h2 class="title-1">Movimientos</h2>
                                </div>
                                <br />
                                <button class="btn btn-success btn-sm" onclick="location.href='entrada_inventario.php';"><i class="fas fa-angle-double-down"></i> Entradas</button>
                                <button class="btn btn-danger btn-sm" onclick="location.href='salida_inventario.php';"><i class="fas fa-angle-double-up"></i> Salidas</button>
                            </div>
                        </div>
                        <!-- <br/>
                        ...
                        <div class="row m-t-25">
                            ...
                            <?php
                                ...
                                $sql = "SELECT * FROM movimientos ORDER BY idMovimiento ASC LIMIT $start_from, $limit";
                            ...
                            <table style="font-size:12px; text-align:center;" class="table table-bordered table-striped">
                                ...
                                <tbody class="BusquedaRapida" >
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $row["idCodigoProducto"]; ?></td>
                            ...
                            <?php
                                ...
                                for ($i=1; $i<=$total_pages; $i++) {
                                            $pagLink .= "<a class='page-link' href='movimientos.php?page=".$i."'>".$i."</a>";  
                                };
                                echo $pagLink . "</div>";
                            ?>
                            <!-- END DATA TABLE-->
