                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    <h2 class="title-1">Usuarios / Listado de Usuarios</h2>
                                    <button class="btn btn-primary btn-sm" onclick="location.href='usuarios_nuevo.php';"><i class="zmdi zmdi-plus"></i> Nuevo</button>
                                </div>
                        ...
                        <div class="table-responsive">
                            ...
                            $sql = "SELECT * FROM usuarios WHERE idUsuario != 1 ORDER BY idUsuario ASC LIMIT $start_from, $limit";  
                            ...
                            <table style="font-size:12px" class="table table-bordered table-striped">  
                                ...
                                <tbody class="BusquedaRapida">  
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                                if ($row['grupo']==1){echo "Administrador";}
                                                elseif ($row['grupo']==2){echo "Vendedor";}
                                            ?>
                                        </td>
                                        <td>
                                            <a href="usuarios_edicion.php?idUsuario=<?php echo $row['idUsuario']?>" class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></a>
                                            <?php
                                                if($row['usuario'] == 'admin' OR 'demo'){}else{
                                            ?>
                                            <a href="delete.php?idUsuario=<?php echo $row['idUsuario'] ?>" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></a>
                                            <?php } ?>
                                        </td>
                                    </tr>  
                                    <?php  
