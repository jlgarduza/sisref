                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-7">
                                <div class="overview-wrap">
                                    <h2 class="title-1">Listado de Grupo de Usuario</h2>
                                </div>
                        ...
                        <div class="table-responsive">
                            ...
                            $sql = "SELECT * FROM grupos ORDER BY idGrupo ASC LIMIT $start_from, $limit";  
                            ...
                            <table style="font-size:12px" class="table table-bordered table-striped">  
                                ...
                                <tbody class="BusquedaRapida">  
                                    ...
                                    <tr>
                                        ...
                                        <!-- <td>
                                            <a href="producto_edicion.php?idProducto=<?php echo $row['idProducto']?>" class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></a>
                                            <a href="delete.php?idProducto=<?php echo $row['idProducto'] ?>" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></a>
                                        </td> -->
                                    </tr>  
                                    <?php  
                                    };  
