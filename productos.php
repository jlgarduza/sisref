                                    ...
                                    <div class="account-item clearfix js-item-menu">
                                        ...
                                        <div class="account-dropdown js-dropdown">
                                            ...
                                            <div class="account-dropdown__footer">
                                                <a href="logout.php"><i class="zmdi zmdi-power"></i>Cerrar Sesión</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input id="FiltrarContenido" type="text" class="form-control" placeholder="Ingrese Nombre del Producto" aria-label="Alumno" aria-describedby="basic-addon1">
                        </div>
                        <div class="table-responsive">
                            ...
                            <?php
                                ...
                                $sql = "SELECT * FROM productos ORDER BY descripcion ASC LIMIT $start_from, $limit"; 
                                $rs_result = mysqli_query($cnx, $sql);
                                $contador = 0;
                            ?>
                            <table id="demo" style="font-size:12px" class="table table-bordered table-striped">  
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                                ...
                                                $entrada = $row['entrada'];
                                                $salida = $row['salida'];
                                                $total = $existencia+$entrada-$salida;
                                                echo $total;
                                            ?>
                                        </td>
                                        <?php
                                        ...
                                        <?php
                                            ...
                                            if($grupo == 1){
                                        ?>
                                        <td><a href="producto_edicion.php?idProducto=<?php echo $row['idProducto']?>" class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></a></td>
                                        <td><a href="delete.php?idProducto=<?php echo $row['idProducto'] ?>" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></a></td>
                                        <?php }else{} ?>
                                    </tr>  
                                    <?php  
                                    };  
