                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    ...
                                    <button class="btn btn-primary btn-sm" onclick="location.href='empleado_nuevo.php';"><i class="zmdi zmdi-plus"></i> Nuevo</button>
                                </div>
                        ...
                        <div class="row colg-lg-12">
                            <div class="col-lg-6">
                                <div class="table-responsive">
                                    ...
                                    $sql = "SELECT * FROM empleados ORDER BY idEmpleado ASC LIMIT $start_from, $limit";  
                                    ...
                                    <table style="font-size:12px" class="table table-bordered table-striped">  
                                        ...
                                        <tbody class="BusquedaRapida">  
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="usuarios_edicion.php?idEmpleado=<?php echo $row['idEmpleado']?>" class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></a>
                                                    <a href="delete.php?idEmpleado=<?php echo $row['idEmpleado'] ?>" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></a>
                                                </td>
                                            </tr>  
                                            <?php  
                                            };  
