                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-5">
                                <div class="overview-wrap">
                                    <h2 class="title-1">Salida Inventario</h2>
                                </div>
                        ...
                        <div class="row m-t-25">
                            <form  method="POST" class="form-horizontal" action="">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="codigo" autofocus autocomplete="off" />
                                </div>
                                <div class="form-group">
                                    <label for="entrada">Cant. Salida</label>
                                    <input type="text" class="form-control" name="salida" />
                                </div>
                                <input type="submit" name="salidaInv" value="Ingresar Salida" class="btn btn-primary">
                            </form>
                        </div>
                        ...
                        <?php
                                ...
                                if (@$_POST['salidaInv']) {
                                    ...
                                    $insertarMovimiento = $cnx->query("INSERT INTO movimientos(idCodigoProducto,Cantidad,TipoOperacion,Creado,FechaCreado) VALUES('$postcodigo','$postsalida','$operacion','$creado','$fecha')");
                                    ...
                                    $productos = $cnx->query("SELECT * FROM productos WHERE codigo = '$postcodigo' ");
                                    ...
                                    $actualizarSalida = $cnx->query("UPDATE ".$tblProductos." SET existencia = ".$ExistenciaProducto." - ".$cantidad."  WHERE ".$colname." = ".$postcodigo."");
                                    // $actualizarSalida = $cnx->query("UPDATE ".$tblProductos." SET existencia = ".$total_existencia." WHERE ".$colname." = ".$postcodigo."");
                                    if ($actualizarSalida) {
                                        echo '<label class="alert alert-success"><strong>Exito!</strong> Salida registrada!</label>';
                                        header('REFRESH:2; URL=movimientos.php');
                                    }else{
                                        echo '<label class="alert alert-danger"><strong>Error!</strong> Salida no registrada!</label>';
                                    }
                                }
                            ?>
